            ...
            <div class="row">
                ...
                <div class="col-md-12" id="tablapruebaGeneral">
                    <table class="table table-bordered" cellspacing="0">
                        <tr>
                            <td colspan="4" align="center"><strong>REGISTRO DE EVALUACION DE LA FORMACION</strong></td>
                        ...
                        <tr>
                            <td colspan="5"><strong>Valor Total: </strong>$<?php echo number_format(odbc_result($Func->CabCap($NROPROG), 'PRECIO'), 1) ?> </td>
                        </tr>
                        <tr align="center">
                            <td><strong>NOMBRE</td>
